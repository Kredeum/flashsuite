    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div8, file, 27, 12, 1357);
    			...
    			add_location(img1, file, 28, 36, 1432);
    			attr_dev(div9, "class", "blockimage");
    			add_location(div9, file, 28, 12, 1408);
    			attr_dev(div10, "class", "frostedglasswrapper");
    			add_location(div10, file, 26, 10, 1311);
    			attr_dev(a1, "id", "flashPosTrigger");
    			attr_dev(a1, "href", "/flashposition");
