...
async function get0xPairPrice({asset1 = 'DAI', asset2 = 'WETH', amount = '1000000000000000000',  network = 'mainnet', _selectedExchange}) {
  let arrayEx = ["Native", "Uniswap", "Uniswap_V2", "Eth2Dai", "Kyber", "Curve", "LiquidityProvider", "MultiBridge", "Balancer", "CREAM", "Bancor", "mStable", "Mooniswap", "MultiHop", "Shell", "Swerve", "SnowSwap", "SushiSwap", "DODO"];
  // https://github.com/0xProject/0x-monorepo/blob/development/packages/asset-swapper/src/utils/market_operation_utils/types.ts#L27
  // CryptoCom not exists in source, make errors in WETH-DAI price for DODO...
