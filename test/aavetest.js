...
describe("AaveTest deployment and run", function () {
  ...
  it("Should run AaveTest Contract and start FlashLoan", async function () {
    ...
    console.log("Contract  https://kovan.etherscan.io/address/" + aaveTest.address);
    ...
    await tx2.wait();
    console.log("Sent!     https://kovan.etherscan.io/address/" + aaveTest.address);
    ...
    console.log("Dai       https://kovan.etherscan.io/address/" + aaveTestDai.address);

    const tx3 = await aaveTestDai.transfer(aaveTest.address, ethers.utils.parseEther(aaveTestDAI));
    ...
    try {
      ...
      const tx5 = await aaveTest.rugPullERC20();
      console.log("Tx5       https://kovan.etherscan.io/tx/" + tx5.hash);
      const tx6 = await aaveTest.rugPullETH();
